...
def test_create_and_delete_agent(user_test):
    agent_data = {
        "name": "Agent Test 2",
...
def test_create_agent_unauthorized_with_invalid_api_key():
    agent_data = {
        "name": "Agent Test 2",
        "description": "Agent test 2",
        "system_prompt": "Test agent 2",
...
def test_update_agent(user_test, agent_test):
    agent_data = {
        "name": "Agent Test 3",
    }  
...
def test_update_agent_unauthorized_with_invalid_api_key(agent_test):
    agent_data = {
        "name": "Agent Test 3",
    }  
